    ...
    method onCheckUpgrades {} {
        ...
        if {$DBPath eq {}} then {
            if {$tcl_platform(platform) != "windows"} then {
                ...
                set DBPath {C:\\msys64\\var\\lib\\pacman}
            }
        }
        ...
        if {![file exists $DBPath]} then {
            ...
            chan puts $chan "echo \"pacman --sync --refresh --dbpath '${tmpDB}'\""
            chan puts $chan "pacman --sync --refresh --dbpath '${tmpDB}'"
            chan puts $chan "echo \"\""
